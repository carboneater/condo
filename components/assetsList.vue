<template>
	<div class="flex flex-row justify-between">
		...
		<button class="border border-emerald-600 text-emerald-600 px-1.5 rounded-md" @click="onNew">New</button>
	</div>
	<div class="flex flex-col">
		<div class="border border-solid border-slate-600 flex-row justify-between rounded-lg" v-for="asset in props.assets">
